...
print(f"you spend ${rent:.2f} on rent and that is {rentpercent:.2f}% of your income")
# tell user catagorie spending amount AND percent for utilities ("you spend $XX.XX on utilities and that is XX% of your income")
print(f"you spend ${utilities:.2f} on utilities and that is {utilitiespercent:.2f}% of your income")
# tell user catagorie spending amount AND percent for groceries ("you spend $XX.XX on groceries and that is XX% of your income")
print(f"you spend ${groceries:.2f} on groceries and that is {groceriespercent:.2f}% of your income")
...
print(f"you spend ${spending:.2f} on spending and that is {spendingpercent:.2f}% of your income")
# tell user catagorie spending amount AND percent for savings ("you spend $XX.XX on savings and that is 10% of your income")
print(f"you spend ${savings:.2f} on savings and that is 10% of your income")